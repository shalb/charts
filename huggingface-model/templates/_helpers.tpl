...
{{- default (default .Chart.Name .Values.nameOverride) .Values.model.name | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default (default .Chart.Name .Values.nameOverride) .Values.model.name }}
